    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Enterthe deatils to start trackin a new crop session
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  handleSelectChange("veg_variety ", value)
                }
              >
                <SelectTrigger>
                ...
                <SelectContent className="bg-green-50">
                  <SelectItem value="Largr Long Summer">
                    Large Long Summer
                  </SelectItem>
                  <SelectItem value="Detroit Dark Red">
                    Detroit Dark Red
                  </SelectItem>
                  ...
                  <SelectItem value="Hybrid Red Creole">
                    Hybrid Red Creole
                  </SelectItem>
                  ...
                  <SelectItem value="HORDI Lenairi 1">
                    HORDI Lenairi 1
                  </SelectItem>
                  <SelectItem value="Thinnaweli purple">
                    Thinnaweli purple
                  </SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  handleSelectChange("seed_type", value)
                }
              >
                <SelectTrigger>
                ...
                <SelectContent className="bg-green-50">
                  <SelectItem value="Department of Agriculture (DOA)">
                    Department of Agriculture (DOA)
                  </SelectItem>
                  <SelectItem value="Private Seed Suppliers">
                    Private Seed Suppliers
                  </SelectItem>
                  <SelectItem value="Local Agricultural Shops">
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  handleSelectChange("soil_type", value)
                }
              >
                <SelectTrigger>
                ...
                <SelectContent className="bg-green-50">
                  ...
                  <SelectItem value="Sandy Loam Soil">
                    Sandy Loam Soil
                  </SelectItem>
                  <SelectItem value="Loamy Soil">Loamy Soil</SelectItem>
                  <SelectItem value="Silty Loam Soil">
                    Silty Loam Soil
                  </SelectItem>
                  <SelectItem value="Red Yellow Podzolic">
                    Red Yellow Podzolic
                  </SelectItem>
                  <SelectItem value="Mountain Reddish Brown">
                    Mountain Reddish Brown
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
