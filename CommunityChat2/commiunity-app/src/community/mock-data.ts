...
export const mockUsers: User[] = [
  {
    ...
    location: "Iowa, USA",
    bio: "Growing corn and soybeans for over 20 years. Passionate about sustainable farming practices and soil conservation. My farm has been in the family for three generations.",
  ...
  },
  {
    ...
    bio: "Organic vegetable farmer specializing in tomatoes and peppers. Advocate for local food systems. Running a 15-acre farm with drip irrigation and greenhouse operations.",
  ...
  },
  {
    ...
    location: "Texas, USA",
    bio: "Cattle rancher with focus on regenerative grazing. Always looking to learn new techniques. Managing 200 head of cattle on 500 acres using rotational grazing methods.",
  ...
  },
  {
    ...
    bio: "Poultry farmer and agricultural educator. Interested in technology applications for small farms. Running a free-range egg operation with 500 laying hens.",
  ...
  },
  {
    ...
    bio: "Specializing in berry farming with focus on blueberries and raspberries. Early adopter of precision agriculture techniques and drone monitoring for crop health.",
